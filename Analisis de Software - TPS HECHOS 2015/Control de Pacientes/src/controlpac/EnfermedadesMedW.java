 ...
 */
public class EnfermedadesMedW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listaEnf = new javax.swing.JTextArea();
        ...
        jLabel1.setText("<html><u>Enfermedades que atiende cada médico</u></html>");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 11, 290, 26);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setText("Nombre del médico:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(19, 141, 119, 15);
        ...
        nombreMed.setSelectionColor(new java.awt.Color(153, 153, 153));
        getContentPane().add(nombreMed);
        nombreMed.setBounds(156, 139, 144, 20);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enfermedades que atiende:"));

        listaEnf.setEditable(false);
        listaEnf.setColumns(20);
        listaEnf.setRows(5);
        jScrollPane1.setViewportView(listaEnf);
        ...
        jPanel1.setBounds(10, 170, 310, 199);
        ...
        anterior.setBounds(10, 375, 100, 30);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(codigoMed, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 44, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(consultarBtn)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(borrarC, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    while (sw != 0) {
       ...
       if (codme.equals(codMed) && checkEnfermedades.indexOf(enfp)==-1) { //compara el codigo medico de la tabla "datomed"  con el de la tabla "situpac"
            ...
            checkEnfermedades= checkEnfermedades +"#"+ enfp; // uso el signo # para separar las enfermedades ya encontrados para listar.
            lista = lista + enfp + "\n"; //Acumulo en la lista
        }
      } catch (Exception e) {
         sw = 0;
 ...
 public void consultarEnfermedades(){
        ...
        try {
            ...
            if (!found) { // si el medico no se encontro se informa
                ...
                listaEnf.setText(lista); //Mestro la lista                
        } catch (IOException ioe) {
            JOptionPane.showMessageDialog(null, "No se ha encontrado información sobre el médico solicitado.");
        };
}    
    ...
    private void consultarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarBtnActionPerformed
        ...
        if(!medico.medicoExiste()){ //Si no existe.
            ...
            consultarEnfermedades(); // Existe el médico, enotnces muestro las enfermedades que atiende.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnfermedadesMedW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnfermedadesMedW().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea listaEnf;
